...
PERSONAS = [
    "预算敏感的大学生，关注性价比和学习需求",  # 关注价格和基本功能
    "注重品质的设计师，需要高性能工作设备，预算无上限",     # 专业需求，重视性能
    "忙碌的企业主，寻求高效办公解决方案",       # 企业采购，重视效率
    "爱拍照的大学女生，关注手机摄影和时尚外观",   # 手机与时尚
    "重视健身的白领，需要便携平板和智能手表",   # 健康与可穿戴设备
    "技术极客，关注最新高端旗舰笔记本和DIY升级空间", # 高端配置，可扩展性
    "省心的退休教师，寻求易用的家用一体机与售后无忧", # 长者友好，售后服务
    "游戏玩家，想买高刷新率电竞显示器和外设",     # 电竞外设
    "高校信息化主管，批量采购计算机教室设备并关注教育优惠", # 批量采购，教育优惠
    "跨国远程办公的产品经理，需要轻薄商务本和全球联保服务", # 远程办公，全球联保
    # 复合场景
    "企业采购负责人，批量采购设备并关注企业会员优惠和售后服务",
    "家长为孩子选购学习平板，关注护眼和家长控制功能",
    "摄影爱好者，关注高像素手机和配套云存储服务",
    "小微企业主，关注办公一体机和财务软件兼容性",
    "学生党，关注笔记本轻薄便携和长续航，预算有限",
    "老年用户，关注设备易用性和远程协助功能"
]
...
<answer>
{
  ...
  "actions": [
    ...
    },
    {
      ...
      "arguments": {"product_ids_to_compare": ["placeholder", "placeholder"]}
    },
    {
...
<answer>
{
  "intent": "你是一家刚成立两年的科技创业公司的CEO，公司主要做软件开发业务，目前团队有15个人。你需要为新招聘的5名开发工程师采购笔记本电脑，主要用于软件开发、代码编写、测试等工作。你对成本控制比较敏感，希望每台预算控制在8000-12000元之间。作为企业采购，你希望能享受到批量采购的优惠，同时也关注售后服务和质量保障。你性格比较务实，喜欢通过数据和具体对比来做决策。",
  "actions": [
    {
      "name": "product_recommend",
